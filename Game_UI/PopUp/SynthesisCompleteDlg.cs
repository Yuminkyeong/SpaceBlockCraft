...
public class SynthesisCompleteDlg : MonoBehaviour
{
    ...
    public void UpdateData()
    {
        ...
        m_gItem1 = CWArrayManager.Instance.GetItemData(SynthesisDlg.Instance.m_nItem);
        m_gItem2 = CWArrayManager.Instance.GetItemData(SynthesisDlg.Instance.m_nItem2);
        ...
        level.text = string.Format("Lv. {0}", m_gItem1.level.ToString());
        level2.text = string.Format("Lv. {0}", m_gItem2.level.ToString());
