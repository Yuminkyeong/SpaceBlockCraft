...
namespace B83.ExpressionParser
{
    ...
    public class OperationBuho : IValue
    {
        private IValue m_Value;
        private IValue m_Value2;
        public double Value
        {
            get {
                if (m_Value.Value > m_Value2.Value) return 1;
                return 0;
               }
        }
        public OperationBuho(IValue aValue, IValue aPower)
        {
            m_Value = aValue;
            m_Value2 = aPower;
        }
    ...
    public class OperationBuho2 : IValue
    {
        private IValue m_Value;
        private IValue m_Value2;
        public double Value
        ...
        public OperationBuho2(IValue aValue, IValue aPower)
        {
            m_Value = aValue;
            m_Value2 = aPower;
        }
    ...
    public class OperationBuho3 : IValue
    {
        private IValue m_Value;
        private IValue m_Value2;
        public double Value
        ...
        public OperationBuho3(IValue aValue, IValue aPower)
        {
            m_Value = aValue;
            m_Value2 = aPower;
        }
    ...
    public class OperationBuho4 : IValue
    {
        private IValue m_Value;
        private IValue m_Value2;
        public double Value
        ...
        public OperationBuho4(IValue aValue, IValue aPower)
        {
            m_Value = aValue;
            m_Value2 = aPower;
        }
    ...
    public class OperationEqual : IValue
    {
        ...
        public OperationEqual(IValue aValue, IValue aPower)
        {
            m_Value = aValue;
            m_Value2 = aPower;
        }
    ...
    public class OperationAnd : IValue
    {
        ...
        public double Value
        {
            ...
            {
                bool b1, b2;
                if (m_Value.Value == 0) b1 = false;
                else b1 = true;

                if (m_Value2.Value == 0) b2 = false;
                else b2 = true;
        ...
        public OperationAnd(IValue aValue, IValue aValue2)
        {
            m_Value = aValue;
            m_Value2 = aValue2;
        }
    ...
    public class OperationOR : IValue
    {
        ...
        public OperationOR(IValue aValue, IValue aValue2)
        {
            m_Value = aValue;
            m_Value2 = aValue2;
        }
    ...
    {
        static public Dictionary<string, Parameter> m_Parameters = new Dictionary<string, Parameter>();
        ...
        public ExpressionDelegate ToDelegate(params string[] aParamOrder)
        {
            ...
            {
                if (m_Parameters.ContainsKey(aParamOrder[i]))
                    parameters.Add(m_Parameters[aParamOrder[i]]);
                else
                    parameters.Add(null);
            }
    ...
    public class ExpressionParser
    {
        ...
        IValue Parse(string aExpression)
        {
            ...
            else if (aExpression.Contains(">="))
            {
                int pos = aExpression.IndexOf(">=");
                var val = Parse(aExpression.Substring(0, pos));
                var pow = Parse(aExpression.Substring(pos + 2));
                return new OperationBuho3(val, pow);
            }
            else if (aExpression.Contains("<="))
            {
                int pos = aExpression.IndexOf("<=");
                var val = Parse(aExpression.Substring(0, pos));
                var pow = Parse(aExpression.Substring(pos + 2));
                return new OperationBuho4(val, pow);
            }
            else if (aExpression.Contains('>'))
            {
                int pos = aExpression.IndexOf('>');
                var val = Parse(aExpression.Substring(0, pos));
                var pow = Parse(aExpression.Substring(pos + 1));
                return new OperationBuho(val, pow);
            }
            else if (aExpression.Contains('<'))
            {
                int pos = aExpression.IndexOf('<');
                var val = Parse(aExpression.Substring(0, pos));
                var pow = Parse(aExpression.Substring(pos + 1));
                return new OperationBuho2(val, pow);
            }
            ...
            else if (aExpression.Contains("=="))
            {
                ...
                var val = Parse(aExpression.Substring(0, pos));
                var pow = Parse(aExpression.Substring(pos + 2));
                return new OperationEqual(val, pow);
            }
            else if (aExpression.Contains("&&"))
            {
                int pos = aExpression.IndexOf("&&");
                var val = Parse(aExpression.Substring(0, pos));
                var pow = Parse(aExpression.Substring(pos + 2));
                return new OperationAnd(val, pow);
            }
            else if (aExpression.Contains("||"))
            {
                int pos = aExpression.IndexOf("||");
                var val = Parse(aExpression.Substring(0, pos));
                var pow = Parse(aExpression.Substring(pos + 2));
                return new OperationOR(val, pow);
            }
            ...
            {
                if (Expression.m_Parameters.ContainsKey(aExpression))
                {
                    return Expression.m_Parameters[aExpression];
                }
                    
                //var val = new Parameter(aExpression);
                //Expression.m_Parameters.Add(aExpression, val);
                //return val;
            }
